<template>
  <div
    class="flex items-center justify-between p-3 max-md:bg-gray-200 max-md:dark:bg-[#1d2021] text-gray-800 dark:text-stone-300 max-md:py-3 max-md:px-4 max-md:mt-3 rounded-lg transition-border-bg duration-500">
    ...
    <button
      ...
      <span
        class="absolute top-[1px] left-[1px] w-[18px] h-[18px] rounded-xl bg-white dark:bg-gray-900 shadow translate-x-0 dark:translate-x-[18px] transition-transform duration-300">
        <span class="relative block w-[18px] h-[18px] rounded-xl overflow-hidden">
          <span class="relative block w-[18px] h-[18px] rounded-xl overflow-hidden">
            <svg
              ...
              focusable="false"
              viewBox="0 0 24 24"
              class="dark:hidden absolute top-[3px] left-[3px] w-3 h-3 fill-slate-900 transition-colors duration-500">
              <path
            ...
            <svg
              ...
              focusable="false"
              viewBox="0 0 24 24"
              class="hidden dark:block absolute top-[3px] left-[3px] w-3 h-3 fill-gray-50 transition-colors duration-500">
              <path
